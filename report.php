<?php
    ...
    // perform insertion.
    $sql = "INSERT INTO `student_details`(`name`, `password`, `email`, `age`, `gender`, `society`, `course`, `address`) VALUES ('".$name."','".$password."','".$email."','".$age."','".$gender."','".$society."','".$courses."','".$address."')";
    
    // assuming i have a database callesd logins where student_details tabel is stored
